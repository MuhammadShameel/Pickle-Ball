          ...
          <div className="cart mt-12">
            <table className="w-full">
              <thead className="py-2.5">
                <tr className="text-left">
                  ...
                  <th className="py-2.5 hidden md:table-cell">
                    <span className="fs-18 text-black leading-normal">
                      Price
                    </span>
                  </th>
              ...
              <tbody>
                {cartProducts.map((product) => (
                  <tr key={product.id} className="border-t border-[#E5E5E5]">
                    <td className="w-[35%] lg:w-[30%] xl:w-[30%] 2xl:w-[25%] md:py-5">
                      <Link
                        href={"#"}
                        className="group hover:underline transition-all"
                      >
                        <div className="flex flex-row gap-3 items-center justify-start">
                          <div className="img-wrapper min-w-[70px] md:min-w-[80px] lg:min-w-[95px] xl:min-w-[112px] aspect-square rounded-[10px] overflow-hidden">
                            <Image
                          ...
                          <div className="">
                            <p className="cart-item_name text-black leading-normal group-hover:underline transition-colors">
                              {product.title}
                            </p>
                            <div className="total-price_mobile mt-2 md:hidden">
                              <h3 className="text-black font-bold! font-wide leading-[100%]">
                                {(
                                  parseFloat(
                    ...
                    <td className="w-[15%] lg:w-[20%] xl:w-[20%] 2xl:w-[25%] py-5 align-text-top hidden md:table-cell">
                    ...
                    <td className="py-5 align-text-top text-center w-[5%] md:w-[10%] lg:w-auto">
            ...
            <div className="mt-7.5 md:mt-10 lg:mt-12.5">
              ...
              <div className="mt-3 md:mt-4">
                <FrequentlyBoughtWith className="md:grid-cols-2 lg:grid-cols-4" />
              </div>
            </div>
            ...
            <div className="mt-12 ">
              <div className="w-full md:w-[50%] border-t border-[#E5E5E5]">
                ...
                <button
                  className="btn style-2 btn-primary  leading-normal cursor-pointer w-full mt-7"
