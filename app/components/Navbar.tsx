        ...
        <>
            <header className="text-[#00000099] body-font">
                <div className="container mx-auto flex flex-wrap py-10  flex-row items-center">
                    ...
                    {/* Desktop Links */}
                    <nav className={`md:ml-auto md:mr-auto lg:flex md:flex flex-wrap items-center text-base hidden justify-center ${isMenuOpen ? 'hidden' : ''}`}>
                    ...
                    <div className='gap-2.5 lg:flex md:flex hidden'>
                        {/* Desktop buttons */}
                    ...
                    {/* Mobile Menu Button */}
                    <button onClick={handleMenuClick} className="md:hidden ml-auto flex items-center p-2  rounded-full hover:bg-[#B2FFA9] transition">
            ...
            >
                <nav className="flex flex-col items-center py-10">
                    ...
                    {/* Account and Bag buttons inside mobile menu */}
                    <div className="flex gap-2.5 mt-8">
                        <button className="inline-flex items-center border-[#00000099] hover:border-[#1E503F] border-1 p-2.5 focus:outline-none rounded-full hover:bg-[#B2FFA9] transition ease-in-out text-base cursor-pointer">
                            <Image src={Profile} alt="Profile" />
                        </button>
                        <button className="inline-flex items-center border-[#00000099] hover:border-[#1E503F] border-1 p-2.5 focus:outline-none rounded-full hover:bg-[#B2FFA9] transition ease-in-out text-base cursor-pointer">
                            <Image src={Bag} alt="Bag" />
