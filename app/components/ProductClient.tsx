            ...
            <section className="px-3 sm:px-3.5 md:px-5 pt-8">
                <div className="container mx-auto">
                    <div className="flex flex-col lg:flex-row">
                        <div className="w-full lg:w-1/2 pe-18 border border-red-500 overflow-hidden">
                            <div className="product-gallery sticky top-5">
                                <div className="img-wrapper product-image-preview-wrapper aspect-square rounded-[10px] overflow-hidden">
                            ...
                            <div className="flex flex-row flex-wrap gap-2 mt-7">
                                {colorVariants.map((hex, i) => (
                                    <div
                                        ...
                                        className={`w-[70px] aspect-square cursor-pointer rounded-full  border transition-all ${activeColorIndex === i
                                            ? "border-black p-3"
